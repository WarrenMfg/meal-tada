    ...
    <>
      ...
      <main className='card mb-2'>
        <div className='card-body'>
          <h2>Flank Steak and French Fries</h2>
          <h3
          ...
          <div className='d-flex'>
            ...
            />
            <div
              className='card-summary d-flex flex-column justify-content-between'
            >
              <p>
                ...
                gravida at eget metus. Ut enim ad minim veniam, quis nostrud exercitation
